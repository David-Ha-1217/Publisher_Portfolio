...
<head>
    ...
    <title>JACOB'S LADDER - 회원탈퇴</title>
    ...
    <!-- ---------------- 콘텐츠 영역 (del_user.html) ---------------- -->
    <link rel="stylesheet" href="./css/del_user.css">
...
<body>
    ...
    <div id="cntWrap">
        ...
        <section id="contents">
            ...
            <button type="button" id="delOk">회원 탈퇴</button>
