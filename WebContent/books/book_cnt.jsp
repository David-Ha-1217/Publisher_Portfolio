...
<head>
    ...
    <!-- ----- 콘텐츠 영역 (book_cnt.jsp) ----- -->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/books/css/book_cnt.css">
...
<body>
    ...
    <div id="contents">
        ...
        <div id="bookInfo">
            ...
            <div id="store">
                <h3>도서구매 사이트</h3>
                <a href="http://www.kyobobook.co.kr/product/detailViewKor.laf?ejkGb=KOR&mallGb=KOR&barcode=9791163031222&orderClick=LEa&Kc="><img src="${pageContext.request.contextPath}/images/kyobo.png"></a>
                <a href="http://www.yes24.com/Product/Goods/84803146?Acode=101"><img src="${pageContext.request.contextPath}/images/yes24.gif"></a>
                <a href="https://www.aladin.co.kr/shop/wproduct.aspx?ItemId=220609696&start=slayer"><img src="${pageContext.request.contextPath}/images/al.gif"></a>
            </div>
