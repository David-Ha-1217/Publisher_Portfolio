...
<head>
    ...
    <title>JACOB'S LADDER - 아이디 찾기</title>
        ...
        function cite_check() {
            ...
            if(document.getElementById("member_email").value) {
                ...
                if(document.getElementById("member_email").value == emailDB){
                    ...
                    // 남은 시간
                    var leftSec = 20,
                    display = document.querySelector('#nowTimes');
...
<body>
    ...
    <!-- ---------------------------- 콘텐츠 영역 ------------------------------- -->
    <form name="id_Form" onsubmit="return false">
        <div id="contents">
            
            <h1>아이디 찾기</h1>
            <hr>
            <h4>회원가입시 등록한 이메일을 입력해 주세요.</h4>
            ...
            <div id="id_findInput">
                ...
                <span id="nowTimes" disabled="true"></span>
            </div>

            <!-- 콘텐츠 영역 >> btnWrap -->
            <div id="btnWrap">
                <button type="button" id="id_findBtn" onclick="idfrind();">아이디 찾기</button>
